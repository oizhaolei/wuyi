...
elseif ($action == 'order_detail')
{
    ...
    $order['return_status'] = $_LANG['rs'][$order['return_status']];
...
else if ($action == 'order_query')
{
    ...
    $order_query['order_status'] = $_LANG['os'][$row['order_status']] . ',' . $_LANG['ps'][$row['pay_status']] . ',' . $_LANG['ss'][$row['shipping_status']]. ',' . $_LANG['rs'][$row['return_status']];
