...
$_LANG['app_name'] = 'WUYI';
$_LANG['cp_home'] = '管理中心';
$_LANG['copyright'] = '版权所有 &copy; 2005-'. date('Y') .' XXXXXXXXXXXX有限公司，并保留所有权利。';
...
$_LANG['all_storage_location'] = '所有库存位置';
$_LANG['all_color'] = '所有颜色';
$_LANG['all_style'] = '所有款式';
$_LANG['refresh'] = '刷新';
...
$_LANG['06_color'] = '租品颜色';
$_LANG['06_color_list'] = '租品颜色列表';
$_LANG['06_color_add'] = '添加租品颜色';
$_LANG['07_style'] = '租品款式';
$_LANG['07_style_list'] = '租品款式列表';
$_LANG['07_style_add'] = '添加租品款式';
$_LANG['19_storage_location'] = '库存位置';
$_LANG['19_storage_location_list'] = '库存位置列表';
$_LANG['19_storage_location_add'] = '添加库存位置';
$_LANG['08_goods_type'] = '租品类型';
$_LANG['08_goods_type_list'] = '租品类型列表';
$_LANG['08_goods_type_add'] = '添加租品类型';
$_LANG['09_attribute'] = '租品属性';
$_LANG['09_attribute_list'] = '租品属性列表';
$_LANG['10_attribute_add'] = '添加租品属性';
...
$_LANG['report_sell'] = '出租概况';
$_LANG['sell_stats'] = '出租排行';
$_LANG['sale_list'] = '出租明细';
...
$_LANG['color_alias_exist'] = '已存在相同的颜色别名!';
