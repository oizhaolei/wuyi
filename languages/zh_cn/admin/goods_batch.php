...
$_LANG['notice_file'] = '（CSV文件中一次上传租品数量最好不要超过1000，CSV文件大小最好不要超过500K.）';
...
$_LANG['use_help'] = '使用说明：' .
        '<ol>' .
          ...
          '<li>填写csv文件，可以使用excel或文本编辑器打开csv文件；<br />' .
              ...
              '租品图片和租品缩略图请填写带路径的图片文件名，其中路径是相对于 [根目录]/images/ 的路径，例如图片路径为[根目录]/images/200610/abc.jpg，只要填写 200610/abc.jpg 即可；<br />' .
               '<font style="color:#FE596A;">如果是淘宝助理格式请确保cvs编码为在网站的编码，如编码不正确，可以用编辑软件转换编码。</font></li>' .
          '<li>将填写的租品图片和租品缩略图上传到相应目录，例如：[根目录]/images/200610/；<br />'.
              '<font style="color:#FE596A;">请首先上传租品图片和租品缩略图再上传csv文件，否则图片无法处理。</font></li>' .
          '<li>选择所上传租品的分类以及文件编码，上传csv文件</li>' .
        '</ol>';

$_LANG['js_languages']['please_select_goods'] = '请您选择租品';
$_LANG['js_languages']['please_input_sn'] = '请您输入租品货号';
...
$_LANG['upload_goods']['integral'] = '积分租用额度';
$_LANG['upload_goods']['original_img'] = '租品原始图';
$_LANG['upload_goods']['goods_img'] = '租品图片';
$_LANG['upload_goods']['goods_thumb'] = '租品缩略图';
$_LANG['upload_goods']['keywords'] = '租品关键词';
$_LANG['upload_goods']['goods_brief'] = '简单描述';
$_LANG['upload_goods']['goods_desc'] = '详细描述';
$_LANG['upload_goods']['goods_weight'] = '租品重量（kg）';
...
$_LANG['upload_goods']['is_alone_sale'] = '能否作为普通租品出租';
$_LANG['upload_goods']['is_real'] = '是否实体租品';
