...
$_LANG['notice_act_name'] = '如果留空，取拍卖租品的名称（该名称仅用于后台，前台不会显示）';
$_LANG['label_act_desc'] = '拍卖活动描述：';
$_LANG['label_search_goods'] = '根据租品编号、名称或货号搜索租品';
$_LANG['label_goods_name'] = '拍卖租品名称：';
...
$_LANG['pls_search_goods'] = '请先搜索租品';
$_LANG['search_result_empty'] = '没有找到租品，请重新搜索';

$_LANG['pls_select_goods'] = '请选择拍卖租品';
$_LANG['goods_not_exist'] = '您要拍卖的租品不存在';
