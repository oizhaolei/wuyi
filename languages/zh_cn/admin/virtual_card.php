...
//-- 卡片信息
/*------------------------------------------------------ */
$_LANG['virtual_card_list'] = '虚拟租品列表';
...
/* 提示信息 */
$_LANG['replenish_no_goods_id'] = '缺少租品ID参数，无法进行补货操作';
$_LANG['replenish_no_get_goods_name'] = '租品ID参数有误，无法获取租品名';
