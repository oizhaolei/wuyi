...
$_LANG['brandadd_succeed'] = '新品牌添加成功！';
$_LANG['brandedit_succeed'] = '品牌 %s 修改成功！';
$_LANG['brandname_exist'] = '品牌 %s 已经存在！';
$_LANG['drop_confirm'] = '你确认要删除选定的租品品牌吗？';
...
$_LANG['visibility_notes'] = '当品牌下还没有租品的时候，首页及分类页的品牌区将不会显示该品牌。';
