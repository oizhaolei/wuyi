...
$_LANG['label_goods_qty'] = '租品数 / 有效租品数：';
...
/* 添加/编辑活动提交 */
$_LANG['error_goods_null'] = '您没有选择团购租品！';
$_LANG['error_goods_exist'] = '您选择的租品目前有一个团购活动正在进行！';
$_LANG['error_price_ladder'] = '您没有输入有效的价格阶梯！';
$_LANG['error_restrict_amount'] = '限购数量不能小于价格阶梯中的最大数量';

$_LANG['js_languages']['error_goods_null'] = '您没有选择团购租品！';
