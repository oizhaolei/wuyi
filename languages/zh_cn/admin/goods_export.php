...
$_LANG['taobao']['sell_type'] = '租赁方式';
$_LANG['taobao']['shop_price'] = '宝贝价格';
$_LANG['taobao']['deposit_price'] = '宝贝押金';
...
$_LANG['taobao46']['sell_type'] = '租赁方式';
$_LANG['taobao46']['shop_price'] = '宝贝价格';
$_LANG['taobao46']['deposit_price'] = '宝贝押金';
...
$_LANG['taobao46']['marketing_property_mix'] = '出租属性组合';
...
$_LANG['taobao46']['another_of_marketing_property'] = '出租属性别名';
...
$_LANG['paipai4']['auctionType'] = '租赁方式';
...
$_LANG['wuyi']['area_name'] = '租品地区';   // 需要转换成area_id
$_LANG['wuyi']['color_name'] = '租品颜色';   // 需要转换成color_id
$_LANG['wuyi']['market_price'] = '市场租价';
$_LANG['wuyi']['shop_price'] = '本店租价';
...
$_LANG['wuyi']['is_alone_sale'] = '能否作为普通租品出租';
...
$_LANG['custom']['area_name'] = '租品地区';
$_LANG['custom']['color_name'] = '租品颜色';
$_LANG['custom']['market_price'] = '市场租价';
$_LANG['custom']['shop_price'] = '本店租价';
...
$_LANG['custom']['is_alone_sale'] = '能否作为普通租品出租';
