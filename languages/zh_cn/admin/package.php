...
$_LANG['goodsid'] = '活动关联租品';
$_LANG['goods_name'] = '关联租品名称';
...
$_LANG['keywords'] = '租品关键字';
$_LANG['search_goods'] = '租品搜索';
$_LANG['all_goods'] = '可选租品';
$_LANG['package_goods'] = '该礼包的租品';
$_LANG['goods_number'] = '数量';
$_LANG['saving'] = '立即节省';

/* 提示信息 */
$_LANG['no_goods'] = '你输入的租品不存在，请查证后再输入';
...
$_LANG['js_languages']['search_is_null'] = '没有搜索到任何租品，请重新搜索';
