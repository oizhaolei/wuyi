...
$_LANG['cfg_name']['cart_confirm'] = '租用筐确定提示';
...
$_LANG['cfg_desc']['cart_confirm'] = '允许您设置用户点击“加入租用筐”后是否提示以及随后的动作。';
...
$_LANG['cfg_range']['cart_confirm'][1] = '提示用户，点击“确定”进租用筐';
$_LANG['cfg_range']['cart_confirm'][2] = '提示用户，点击“取消”进租用筐';
$_LANG['cfg_range']['cart_confirm'][3] = '直接进入租用筐';
