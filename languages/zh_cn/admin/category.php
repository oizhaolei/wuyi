...
$_LANG['category_edit'] = '编辑租品分类';
$_LANG['move_goods'] = '转移租品';
$_LANG['cat_top'] = '顶级分类';
$_LANG['show_in_nav'] = '是否显示在导航栏';
$_LANG['cat_style'] = '分类的样式表文件';
$_LANG['is_show'] = '是否显示';
$_LANG['show_in_index'] = '设置为首页推荐';
$_LANG['notice_show_in_index'] = '该设置可以在首页的最新、热门、推荐处显示该分类下的推荐租品';
$_LANG['goods_number'] = '租品数量';
$_LANG['grade'] = '价格区间个数';
$_LANG['notice_grade'] = '该选项表示该分类下租品最低价与最高价之间的划分的等级个数，填0表示不做分级，最多不能超过10个。';
...
$_LANG['notice_style'] = '您可以为每一个租品分类指定一个样式表文件。例如文件存放在 themes 目录下则输入：themes/style.css';
...
$_LANG['cat_move_notic'] = '在添加租品或者在租品管理中,如果需要对租品的分类进行变更,那么你可以通过此功能,正确管理你的租品分类。';

$_LANG['cat_move_empty'] = '你没有正确选择租品分类!';

$_LANG['sel_goods_type'] = '请选择租品类型';
$_LANG['sel_filter_attr'] = '请选择筛选属性';
$_LANG['filter_attr'] = '筛选属性';
$_LANG['filter_attr_notic'] = '筛选属性可在前分类页面筛选租品';
